...
# python train/train.py -n nvisii_shoe1 -c conf/exp/srn.conf -D /media/jtremblay/bf64b840-723c-4e19-9dbc-f6a092b66406/home/jtremblay/data/google_shoe_single_3-9-22_PIXELNERF/ --nviews 1 
...
def extra_args(parser):
    ...
    parser.add_argument(
        "--eval_view_list", type=str,         
          default="viewlist/test_shoes_list.txt",
          help="Path to eval view list"
    )
